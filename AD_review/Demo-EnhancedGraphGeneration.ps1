...
if ($result1.Success) {
    Write-Host "[OK] Privileged access diagram generated successfully" -ForegroundColor Green
...
if ($result2.Success) {
    Write-Host "[OK] Multiple diagrams generated successfully" -ForegroundColor Green
...
if ($result3.Success) {
    Write-Host "[OK] Diagram generated with timestamp: $($result3.Timestamp)" -ForegroundColor Green
} else {
