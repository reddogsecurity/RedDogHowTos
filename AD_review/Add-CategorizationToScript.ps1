...
Write-Host "[L] EASY (2-3 hours):" -ForegroundColor Green
...
Write-Host "`n[M] MODERATE (4-6 hours):" -ForegroundColor Yellow
...
Write-Host "`n[H] COMPLEX (8-12 hours):" -ForegroundColor Red
