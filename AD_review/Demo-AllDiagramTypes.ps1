...
if ($result1.Success) {
    Write-Host "[OK] All diagrams generated successfully!" -ForegroundColor Green
    ...
    Write-Host "[X] Failed: $($result1.Error)" -ForegroundColor Red
}
...
if ($result2.Success) {
    Write-Host "[OK] Security assessment diagrams generated!" -ForegroundColor Green
...
if ($result3.Success) {
    Write-Host "[OK] Infrastructure diagrams generated!" -ForegroundColor Green
    ...
    Write-Host "[X] Failed: $($result3.Error)" -ForegroundColor Red
}
...
if ($riskResult.Success) {
    Write-Host "[OK] Risk overview dashboard generated!" -ForegroundColor Green
    Write-Host "  Use this for executive reporting and high-level risk assessment." -ForegroundColor White
} else {
    Write-Host "[X] Failed: $($riskResult.Error)" -ForegroundColor Red
}
